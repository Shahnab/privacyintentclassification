...
st.sidebar.subheader("1. Data Collection/Usage: What, why and how user information is collected")
st.sidebar.subheader("2. Data Sharing/Disclosure: What, why and how user information is shared with or collected by third parties")
st.sidebar.subheader("3. Data Storage/Retention: How long and where user information will be stored")
st.sidebar.subheader("4. Data Security/Protection: Protection measures for user information")
st.sidebar.subheader("4. Other: Other privacy practices that do not fall into the above four categories")
